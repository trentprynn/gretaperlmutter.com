        ...
        <Container>
                    ...
                    <Row className="justify-content-center">
                        <Col xs="auto">
                            <div style={{ maxWidth: '420px' }}>
                                ...
                                <p className="mt-5">
                                    Greta is a dependable and motivated actress based in NYC. She has the spunk and
                                    silliness of a character actress as well as the heart of a powerfully grounded
                                    performer.
                                </p>
                            </div>
                        </Col>
            ...
            <Row className="mb-5">
                ...
                <Col lg="6" className="order-2 order-lg-1">
                    ...
                    <p>
                        <b>theatre:</b> <a href="https://azbroadway.org/">Arizona Broadway Theatre</a>
                    </p>
                    <p>
                    ...
                    <p>
                        <q cite="https://www.talkinbroadway.com/page/regional/phoenix/phnx880.html">
                            As Percy, Greta Perlmutter makes her ABT debut in a stellar performance that radiates truth
                            and resilience
                        </q>{' '}
            ...
            <Row className="mb-5">
                ...
                <Col lg="6" className="order-2 order-lg-1">
                    ...
                    <p>
                        <b>theatre:</b> <a href="https://www.childsplayaz.org/">Childsplay AZ National Tour</a>
                    </p>
                    <p>
            ...
            <Row>
                ...
                <Col lg="6" className="order-2 order-lg-1">
                    ...
                    <p>
                        <b>theatre:</b> <a href="https://phoenixtheatre.com/">The Phoenix Theatre Company</a>
                    </p>
                    <p>
                        <b>dates:</b> jan 20
                    </p>
                    ...
                    <p>
                        ...
                        >
                            <SlSocialSpotify /> <b className="ms-1">Listen to Original Cast Recording Album</b>
                        </a>
                        <ul>
